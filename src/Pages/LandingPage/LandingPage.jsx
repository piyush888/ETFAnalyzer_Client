          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="#">
                Etf Arbitrage Tracker <span class="sr-only">(current)</span>
              </a>
            </li>
          </ul>
        ...
        <Col md={6} lg={6} xs={12}>
          <div className="">
            <p>
              ...
              ETF industry has surpassed $4 Trillion in assets under management.
              By 2030 ETF industry will surge to $50 Trillion according to{" "}
              <a
